    ...
    <div class="px-5 ms-5 pt-5 pb-5">
        <div class="container-fluid p-0 shadow">
            <div class="d-flex justify-content-between align-items-center bg-km-gray p-3">
                ...
                <div class="">
                    <form action="{{ route('pembelian-csv') }}" method="GET">
            ...
            <div class="bg-white p-3">
                ...
                <table class="table table-bordered border-gray mt-3" id="km-table">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr>
                            <th>{{$no++}}</th>
                            <td>{{ Str::limit($item->user->username, 30, '...')}}</td>
                            <td>{{ Str::limit($item->volManga->manga->judul_manga, 20, '...')}}</td>
                            <td>{{ Str::limit($item->volManga->vol_ke, 20, '...')}}</td>
                            <td>{{ Str::limit(tgl_indonesia($item->tgl_pembelian), 20, '...')}}</td>              
                        </tr>
                        @endforeach
                    </tbody>
                ...
                <div class="justify-content-between d-flex align-items-center">
                    <div class="ps-2">
                        Total data Pembelian: <b><span id="total-data"></span></b>
                    </div>
